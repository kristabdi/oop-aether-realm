...
public class GameState {
    ...
    public void addCardToBoard(Integer boardNumber){
        // add card ke board player 1 atau player 2 berdasarkan isi dari buffer selected card in hand. cek apakah this.selected card itu instanceof charactercard. jika tidak do nothing
    ...
    public boolean isThereACardOnBoardXOnOpponentBoard(int boardNumber){
        if(this.turn == 2){
